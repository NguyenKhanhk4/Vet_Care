...
const getStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  petCard: { width: '48%', backgroundColor: colors.surface, borderRadius: SIZES.radius.base, marginBottom: SIZES.spacing.md, overflow: 'hidden', ...SHADOWS.light },
  petImageContainer: { height: 100, backgroundColor: colors.secondaryLight, justifyContent: 'center', alignItems: 'center' },
  petEmoji: { fontSize: 48 },
  petInfo: { padding: SIZES.spacing.md },
  petName: { fontSize: SIZES.base, color: colors.textPrimary, ...FONTS.semiBold, marginBottom: 2 },
  ...
  petMetaText: { fontSize: SIZES.sm, color: colors.textLight },
  vaccineBadge: { paddingVertical: 4, paddingHorizontal: SIZES.spacing.sm, alignItems: 'center' },
  vaccineText: { fontSize: SIZES.xs, fontWeight: '600' },
